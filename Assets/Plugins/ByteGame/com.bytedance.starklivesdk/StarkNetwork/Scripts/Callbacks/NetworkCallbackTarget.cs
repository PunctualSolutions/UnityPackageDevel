...
// Description: 通用的回调对象基类，虚拟实现了各类 Callback 接口，并提供了注册和注销接口

namespace StarkNetwork
{
    public class NetworkCallbackTarget: IConnectionCallbacks, IMatchmakingCallbacks, IInRoomCallbacks, ISyncMessageCallbacks, IErrorInfoCallback, IOperationCallback
    {
        ...
        public void OnSwitchRoomToken(SerializedSwitchRoomRst swictchInfo)
        {
